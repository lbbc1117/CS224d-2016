...
def cross_entropy_loss(y, yhat):
  ...
  # tf.gather_nd provides a way of tensor indexing, check:
  # https://github.com/tensorflow/tensorflow/issues/206
  # out = - tf.reduce_sum(tf.log(tf.gather_nd(yhat, y)))
  
  out = tf.reduce_sum(tf.to_float(y) * yhat, reduction_indices=1)
