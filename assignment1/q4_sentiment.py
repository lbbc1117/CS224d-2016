...
### YOUR CODE HERE
REGULARIZATION = [1e-6, 3e-6, 6e-6,  1e-5, 3e-5, 6e-5, 1e-4, 3e-4, 6e-4, 1e-3]
### END YOUR CODE
...
# 3e-5 for skipgram & 1e-6 for cbow
# It turns out that softmax classifier is underfitting the dataset
